  ...
  return (
    <div className="flex justify-center mt-8 mb-8">
      <div className="flex flex-col bg-[#efdddc] w-3/2 justify-center p-4 rounded text-gray-800 items-center">
        ...
        <form
          className="grid grid-cols-2 gap-x-8 mx-12"
        ...
        >
          <div className="flex flex-col w-64 relative">
            ...
            <input
              ...
              className="px-2 py-1 my-2 rounded focus:outline-yellow-600 block"
            />
          ...
          <div className="flex flex-col w-64 relative mt-2">
            ...
            <div className="flex">
              <input
                ...
                value="true"
                onChange={formik.handleChange}
                className="mr-2 px-2 py-1 m-2 rounded focus:outline-yellow-600 block"
              />
          ...
          <div className="flex flex-col w-64 relative">
            <p>
              Thématiques abordées dans l'outils <br />
              (Merci de cocher les thématiques abordées)
            </p>
            <div className="mb-4">
              <MyComponent />
            </div>
          ...
          <div className="flex flex-col w-64 relative">
            ...
            <button
              type="submit"
              className="bg-[#b27d71] hover:bg-[#755342] p-2 rounded text-white"
